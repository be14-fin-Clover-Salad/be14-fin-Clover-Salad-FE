    ...
    <div class="dashboard-container">
      ...
      <div class="dashboard-bottom">
        <div class="sales-progress">
          <YearlyEmployeePerformanceLineChart :year="filterYear" :periodType="filterPeriodType" />
        </div>
        <div class="sales-by-teams">
          <TeamPerformanceBarChart :year="filterYear" :periodType="filterPeriodType" :periodValue="filterPeriodValue" :teamColors="teamColors" @totalAmount="handleTotalAmount" />
        </div>
      </div>
    </div>
  </div>
...
<script setup>
import YearEmployeePerformanceCard from "@/components/dashboard/employee/YearEmployeePerformanceCard.vue";
import MonthQuarterEmployeePerformanceCard from "@/components/dashboard/employee/MonthQuarterEmployeePerformanceCard.vue";
import YearlyEmployeePerformanceLineChart from "@/components/dashboard/employee/YearlyEmployeePerformanceLineChart.vue";
import TeamPerformanceBarChart from "@/components/dashboard/employee/TeamPerformanceBarChart.vue";
